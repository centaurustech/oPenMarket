    ...
    <div class="container_12 clearfix">
        ...
        <div class="grid_6">
            <ul class="menuHorizontal menuRight clearfix">
                    ...
                    <li id="loginDropdown">
                    	<a id="btnVOID" class="boton btnAzul oculto" onclick="javacript:marketvoid()"><span>Vaciar productos</span></a>
							<!--<a id="btnNieve" class="boton btnAzul oculto" onclick="javacript:nieve(1)"><span>Cargando...</span></a>-->                    
		...
		<div id="social">
			<i><p>Compartelo en tus redes sociales..</p></i>
