...
; (function ($) {
    ...
    var a_array;
        ...
        styles = { 'dd': 'dd', 'ddTitle': 'ddTitle', 'arrow': 'arrow', 'ddChild': 'ddChild', 'disabled': .30 };
        ...
        function getOptionsProperties(option) {
            ...
            var currentStyles = $(currentOption).attr("style");
            ...
            childnodes.each(function (current) {
                ...
                if (currentOption.nodeName == "OPTGROUP") {
                    ...
                    optChild.each(function (currentopt) {
                        ...
                        arrow = (!arrow || !arrow.length || arrow.length == 0) ? "" : '<img src="' + arrow + '" align="left" /> ';
        ...
        function createTitleDiv() {
            ...
            arrow = (!arrow || !arrow.length || arrow.length == 0 || arrow == undefined || options.showIcon == false) ? "" : '<img src="' + arrow + '" align="left" /> ';
