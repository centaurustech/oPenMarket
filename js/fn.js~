								...
								$.ajax(
								{
									...
									data:
									{
										...
										function(data)
										{
											...
											if(typeof data.status!="undefined")
											{
												...
												if(!data.contenido.usuarioValido)
												{
													...
													$(form).find("#recuperacionContrasena").addClass("warningBox")}
													
													else
													{
														if(data.contenido.contrasenaEnviada){$(form).find("#recuperacionContrasena p").html("Email para recuperar contrase&ntilde;a enviado");
													
													$(form).find("#recuperacionContrasena").addClass("okBox")
													}
													
													else
													{
														$(form).find("#recuperacionContrasena p").html("La contraseña no pudo ser enviada intentelo nuevamente");$(form).find("#recuperacionContrasena").addClass("warningBox")}}
													break;
													case 500:
													break;
										...
										window.location="index.php";
											...
											{
												$('#errorLoginAjaxPostulante').removeClass('oculto');
												$('#Jname').val("");
												$('#passLogin').val("");
											}
