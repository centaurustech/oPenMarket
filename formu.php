...
function checkout()
{
	...
	while(e<=6)
	{
		...
		{			
			...
			{
				$('#D5').text('Solo se permiten numeros telefonicos venezolanos');
...
<?php 
   ...
   echo '<p id="asd1" class="alignCenter"><img src="img/info.png" alt="infobox">Cuentas con un total de <b>' . $_COOKIE['totalPrice'] . '</b> en tus compras.<br><br>Si desea asignar un nombre predeterminado puede cambiarlo <a href="formu.php">en este link</a></p>';
