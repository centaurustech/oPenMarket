<div id="asd" class="container_12 clearfix verticalTabsContainer verticalTabsContainerLeft">
   ...
   <div id="Dgreat" class="okBox oculto">
	<p><strong>Tu compra fue exitosa..! Verifica tu cuenta de correo <a class="irAlTolki" id="Jwebmail" onclick="window.open(this.href,'window','params');marketvoid();return false" href="#"> Ir a tu WebMail →</a></strong></p>
   </div>
