...
<?php include "body.php" ?>
	...
	$dat=$cnx->createCommand('select ventas.fcompra,ventas.ipv4,ventas.totalcmp,ventas.typPago,ventas.transid from ventas where iduser="' . $_COOKIE['pass'] . '" order by ventas.transid desc')->query();

	$dat->bindColumn(1, $fech);
	$dat->bindColumn(2, $ip);
	$dat->bindColumn(3, $total);
	$dat->bindColumn(4, $tyPag);
	$dat->bindColumn(5, $tranID);
	$dat->read();
