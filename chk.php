...
function register_sale($verb)
{
   ...
   if(isset($_POST['Jname']) &&
	...
	//makePDF("modeFACT.php", $fnom . " " . $snom, $dni, $_POST['edoResi'] . " " . $_POST['city'] . " (" . $_POST['paisResi'] . ")", "123", "Santa Ana", $datos, $lol, $_POST['typPago']);			
        ...
        sendMail("demoopenmarket@gmail.com", "Hola, " . $fnom . " " . $snom . " has cancelado un total 	de " . $totalpago . " BsF<br><br>", "Notificacion de compra " . $cnx->createCommand("select name from compania")->queryScalar(), $lol);
